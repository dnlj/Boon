...
TEST_CASE("Algorithm: merge_sort", "[merge_sort][algorithm]") {
	GIVEN("a forward iterating container") {
		...
		THEN("the algorithm is correct") {
			SORT_ALGORITHM_TEST("Boon::merge_sort - forward_iterator", Boon::merge_sort, Container);
		}
	}
	...
	GIVEN("a bidirectional iterating container") {
		...
		THEN("the algorithm is correct") {
			SORT_ALGORITHM_TEST("Boon::merge_sort - bidirectional_iterator", Boon::merge_sort, Container);
		}
	}
	...
	GIVEN("a random access iterating container") {
		...
		THEN("the algorithm is correct") {
			SORT_ALGORITHM_TEST("Boon::merge_sort - random_access_iterator", Boon::merge_sort, Container);
		}
	}
}